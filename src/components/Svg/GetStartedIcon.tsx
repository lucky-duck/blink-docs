...
export default function GetStartedIcon({}: Props) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M12 15C13.0355 15 13.875 14.1605 13.875 13.125C13.875 12.0895 13.0355 11.25 12 11.25C10.9645 11.25 10.125 12.0895 10.125 13.125C10.125 14.1605 10.9645 15 12 15Z"
        stroke="#4467FB"
        stroke-width="1.5"
