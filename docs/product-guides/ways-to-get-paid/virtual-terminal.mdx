...
:::tip
Additional currencies if multiple currencies are enabled on your account, you can select the currency you wish to process the transaction using the drop-down list by clicking on the currency symbol. When you set up a merchant account with us, you are asked which currencies to use to process transactions. You can request additional currencies to be added.
:::
